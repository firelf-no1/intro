...
class ShapesMaster:
    ...
    s = Shape("compound")
    poly1 = (
    (-15, -10), (-16, 0), (-13, 12), (0, 19), (12, 10), (20, 0), (12, -10),
    (0, -13))
    s.addcomponent(poly1, "gray", "gray")
    poly2 = ((-14, -8), (-8, -18), (-1, -7), (-5, -6), (-8, -4))
    s.addcomponent(poly2, "dark gray", "dark gray")
    poly3 = ((2, 1), (4, 2), (6, 3), (7, 5), (3, 8), (0, 4), (0, 2))
    s.addcomponent(poly3, "dark gray", "dark gray")
    ASTEROID_2_LAYOUT = s
    s = Shape("compound")
    poly1 = (
    ...
    (0, -7))
    s.addcomponent(poly1, "gray", "gray")
    poly2 = ((-8, -4), (-4, -10), (3, -3), (-1, -2), (-4, 0))
    s.addcomponent(poly2, "dark gray", "dark gray")
    poly3 = ((-2, -3), (0, -2), (2, -1), (2, 1), (-1, 2), (-2, 0), (-2, 0))
    s.addcomponent(poly3, "dark gray", "dark gray")
    ASTEROID_1_LAYOUT = s
    ...
    ASTEROIDS_LAYOUTS = [ASTEROID_1_LAYOUT, ASTEROID_2_LAYOUT,
                         ASTEROID_3_LAYOUT]
    s = Shape("compound")
    poly1 = ((-2, -23), (-10, -24), (-10, -26), (-2, -27))
    s.addcomponent(poly1, "gray", "white")
    poly2 = ((2, -23), (10, -24), (10, -26), (2, -27))
    s.addcomponent(poly2, "gray", "white")
    poly3 = ((9, -14), (13, -14), (12, -50), (11, -50))
    s.addcomponent(poly3, "gray", "white")
    poly4 = ((-9, -14), (-13, -14), (-12, -50), (-11, -50))
    s.addcomponent(poly4, "gray", "white")
    poly5 = ((-2.5, -9.682), (-1.5, -30), (1.5, -30), (2.5, -9.682))
    s.addcomponent(poly5, "gray", "white")
    poly6 = ((0, -10), (-1, -9.95), (-2, -9.798), (-3, -9.539), (-4, -9.165),
             (-5, -8.66), (-6, -8), (-7, -7.141), (-8, -6), (-9, -4.359),
             (-10, 0), (-9, 4.359), (-8, 6), (-7, 7.141), (-6, 8), (-5, 8.66),
             (-4, 9.165), (-3, 9.539), (-2, 9.798), (-1, 9.95), (0, 10),
             (1, 9.95), (2, 9.798), (3, 9.539), (4, 9.165), (5, 8.66), (6, 8),
             (7, 7.141), (8, 6), (9, 4.359), (10, 0), (9, -4.359), (8, -6),
             (7, -7.141), (6, -8), (5, -8.66), (4, -9.165), (3, -9.539),
             (2, -9.798), (1, -9.95))
    s.addcomponent(poly6, "gray", "white")
    SHIP_LAYOUT = s
    s = Shape("compound")
    poly1 = ((0, -4), (-0.5, -3.969), (-1, -3.873), (-1.5, -3.708),
             (-2, -3.464), (-2.5, -3.122), (-3, -2.646), (-3.5, -1.936),
             (-4, 0), (-3.5, 1.936), (-3, 2.646), (-2.5, 3.122), (-2, 3.464),
             (-1.5, 3.708), (-1, 3.873), (-0.5, 3.969), (0, 4),
             (0.5, 3.969), (1, 3.873), (1.5, 3.708),
             (2, 3.464), (2.5, 3.122), (3, 2.646), (3.5, 1.936),
             (4, 0), (3.5, -1.936), (3, -2.646), (2.5, -3.122), (2, -3.464),
             (1.5, -3.708), (1, -3.873), (0.5, -3.969))
    s.addcomponent(poly1, "yellow", "black")
    poly2 = ((-2.756, 2.756), (-1.2, 1.7), (0, 0.5), (1.2, 1.7), (2.756, 2.756)
             , (1.7, 1.2), (0.5, 0), (1.2, -1.7), (2.756, -2.756), (1.2, -1.7),
             (0, -0.5), (-1.2, -1.7), (-2.756, -2.756), (-1.7, -1.2), (-0.5, 0)
             , (-1.7, 1.2))
    s.addcomponent(poly2, "gold", "black")
    TORPEDO_LAYOUT = s
...
class Screen:
    ...
    def _init_graphics(self):
        ...
        self._screen.bgpic("background013.png")
        ...
        #SpaceShip(livesCanvas,-35,0,0,0)
        life2 = self._get_ship_obj(livesCanvas)
        #SpaceShip(livesCanvas,0,0,0,0)
        life3 = self._get_ship_obj(livesCanvas)
        #SpaceShip(livesCanvas,35,0,0,0)

        self._draw_object(life1,-32,0)
        self._draw_object(life2,15,0)
        self._draw_object(life3,63,0)
    ...
    def should_end(self):
        """
        :returns: True if the game should end or not (if "q" was pressed
        or not)
        """
